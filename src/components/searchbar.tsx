      ...
      <form className="w-full max-w-xl">
        <div className="relative flex items-center">
          ...
          <Input
            ...
            className={`text-md w-full rounded-medium border bg-[#B2B8FF] dark:bg-[#7480FF66] px-12 py-6 play tracking-wider dark:text-white shadow-sm placeholder:dark:text-white placeholder:text-black focus:outline-none focus:ring-2 ${loading ? "opacity-70" : ""}`}
          />
        </div>
        {loading && (
          <div className="text-md absolute z-20 mt-2 w-full max-w-xl rounded-md border border-[#434dba] bg-white p-2 text-center play font-semibold tracking-wider dark:bg-[#030712]">
            Loading suggestions...
          </div>
        )}
